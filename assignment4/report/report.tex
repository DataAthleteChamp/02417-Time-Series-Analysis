...
\begin{figure}[H]
  \centering
  \includegraphics[width=.85\linewidth]{p1_trajectories.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.85\linewidth]{p1_latent_vs_obs.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.95\linewidth]{p1_kf_tracking.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{p1_mle_boxplots.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.7\linewidth]{p1_tdens.pdf}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\linewidth]{p1_robustness_box.pdf}
...
\begin{table}[H]
  ...
  \label{tab:p1-robust}
  \input{tables/p1_robustness.tex}
\end{table}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.95\linewidth]{p2_eda.pdf}
...
\begin{table}[H]
  ...
  \label{tab:p2-1d}
  \input{tables/p2_1d.tex}
\end{table}

\begin{figure}[H]
  \centering
  \begin{subfigure}{.54\linewidth}
    \includegraphics[width=\linewidth]{p2_1d_pred.pdf}
    \caption{1-step predictions.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{.44\linewidth}
    \includegraphics[width=\linewidth]{p2_1d_diag.pdf}
...
\begin{table}[H]
  ...
  \label{tab:p2-2d}
  \input{tables/p2_2d.tex}
\end{table}

\begin{figure}[H]
  \centering
  \begin{subfigure}{.54\linewidth}
    \includegraphics[width=\linewidth]{p2_2d_pred.pdf}
    \caption{1-step predictions.}
  \end{subfigure}
  \hfill
  \begin{subfigure}{.44\linewidth}
    \includegraphics[width=\linewidth]{p2_2d_diag.pdf}
    \caption{Residual diagnostics.}
  \end{subfigure}
...
\begin{figure}[H]
  \centering
  \includegraphics[width=.9\linewidth]{p2_2d_states.pdf}
